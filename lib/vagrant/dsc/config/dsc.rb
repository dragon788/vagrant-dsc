...
module VagrantPlugins
  module DSC
    module Config
      class DSC < Vagrant.plugin("2", :config)
        ...
        def nfs=(value)
          puts "DEPRECATION: The 'nfs' setting for the DSC provisioner is"
        ...
        def validate(machine)
          ...
          if manifests_path[0].to_sym == :host
            ...
            if !expanded_path.directory?
              errors << I18n.t("vagrant.provisioners.dsc.manifests_path_missing",
              ...
              if !expanded_manifest_file.file? && !expanded_manifest_file.directory?
                errors << I18n.t("vagrant.provisioners.dsc.manifest_missing",
          ...
          this_expanded_module_paths.each do |path|
            if !path.directory?
              errors << I18n.t("vagrant.provisioners.dsc.module_path_missing",
                               path: path)
            end
          end
